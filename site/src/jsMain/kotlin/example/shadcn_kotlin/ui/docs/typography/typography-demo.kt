...
val TypographyDemo = FC<Props> {
    div {
        ...
        h2 {
            className = ClassName("mt-10 scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight transition-colors first:mt-0")
            + "The King's Plan"
        }
        p {
            className = ClassName("leading-7 [&:not(:first-child)]:mt-6")
        ...
        h3 {
            className = ClassName("mt-8 scroll-m-20 text-2xl font-semibold tracking-tight")
            +"The Joke Tax"
        }
        p {
            className = ClassName("leading-7 [&:not(:first-child)]:mt-6")
        ...
        p {
            className = ClassName("leading-7 [&:not(:first-child)]:mt-6")
            +"Jokerster began sneaking into the castle in the middle of the night and"
